...
--chip-ink:#fff;--crit:#b3261e;--high:#bf4408;--med:#8a6100;--low:#5b5975;--shadow:0 1px 2px rgba(20,20,30,.04),0 18px 36px -28px rgba(20,20,30,.28)}
...
--chip-ink:#17162a;--crit:#ef8a76;--high:#e8a06a;--med:#d9bd77;--low:#a5a2bd;--shadow:0 1px 2px rgba(0,0,0,.3),0 18px 36px -28px rgba(0,0,0,.6)}}
...
.sev{font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;padding:3px 7px;border-radius:6px;color:var(--chip-ink);margin-top:3px}
...
button.btn{font:inherit;font-size:13.5px;font-weight:600;padding:9px 14px;border-radius:9px;border:1px solid var(--ink);background:var(--ink);color:var(--paper);cursor:pointer;margin-top:14px}
